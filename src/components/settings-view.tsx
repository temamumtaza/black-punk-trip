...
import { NotificationSettingsCard } from "@/components/notification-prompt";
import { Button, Field, TextInput } from "@/components/ui";
import type { NotificationPreference, Trip } from "@/lib/types";
...
export function SettingsView({ trip, creatorName, isAdmin, isOwner, isSavingTrip, isDeletingTrip, notificationPreference, notificationSupported = false, isSavingNotifications = false, onEnableNotifications, onReview, onManageTrips, onSignOut, onSaveTrip, onDeleteTrip }: SettingsViewProps) {
